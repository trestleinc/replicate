...
function IntervalEditorView({
	...
	return (
		<div className="editor-container">
			...
			{onPropertyUpdate && (
				<div className="border-border mt-4 mb-8 flex items-center gap-4 border-b pb-6 text-sm">
					<DropdownMenu>
						<DropdownMenuTrigger className="hover:bg-muted flex items-center gap-2 rounded-sm px-2 py-1 transition-colors">
