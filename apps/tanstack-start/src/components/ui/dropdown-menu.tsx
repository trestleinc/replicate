...
function DropdownMenuRadioItem({ className, children, ...props }: MenuPrimitive.RadioItem.Props) {
	return (
		<MenuPrimitive.RadioItem
			...
			className={cn(
				"focus:bg-muted focus:text-foreground focus:border-sidebar-accent relative flex cursor-default items-center gap-2 rounded-none border-l-2 border-transparent py-2 pr-8 pl-2 text-xs outline-hidden transition-colors select-none focus:border-l-2 data-[disabled]:pointer-events-none data-[disabled]:opacity-50 [&_svg]:pointer-events-none [&_svg]:shrink-0 [&_svg:not([class*='size-'])]:size-4",
				className
			)}
			{...props}
		>
