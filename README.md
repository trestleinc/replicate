...
interface CollectionConfig<T> {
	...
	api: {
		// API from server collection.create()
...
export const replicate = r.createReplicateMutation({
	/* all hooks */
});
...
See [`apps/expo/`](./apps/expo/) for a complete React Native example using Expo.
...
- [`apps/tanstack-start/`](./apps/tanstack-start/) - TanStack Start (React, web)
- [`apps/sveltekit/`](./apps/sveltekit/) - SvelteKit (Svelte, web)
- [`apps/expo/`](./apps/expo/) - Expo (React Native, mobile)
...
export const { stream, material, insert, update, remove, mark, compact } = collection.create<Task>(
	components.replicate,
	'tasks',
	{
		hooks: {
